...
const AdminConfig = ({type="", title}) => {
  ...
  const get = () => {
    toast.promise(request.get(endPoint[type]), {
  ...
  const post = (values) => {
    toast.promise(request.post(endPoint[type], values), {
      pending: "Veuillez patienté...",
      success: {
        render({ data }) {
          console.log(data);
  ...
  const update = (values) => {
    toast.promise(request.post(endPoint[type] + "/" + values.slug, values), {
      pending: "Veuillez patienté...",
      success: {
        render({ data }) {
          console.log(data);
  ...
  const destroy = () => {
    toast.promise(request.delete(endPoint[type] + "/" + viewData.slug), {
      pending: "Veuillez patienté...",
      success: {
        render({ data }) {
          console.log(data);
